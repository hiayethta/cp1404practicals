...
for full_name in full_names:
    if len(full_name) > 11:
        last_name = full_name.split()[-1]  # get last name
        last_names.append(last_name)  # add last name to empty list

last_name_string = ', '.join(last_names)  # join last names into single string
